...
document.getElementById("addiction").addEventListener("click",function(){ ud('+'); });
document.getElementById("substraction").addEventListener("click",function(){ ud('-'); });
document.getElementById("multipication").addEventListener("click",function(){ ud('*'); });
document.getElementById("division").addEventListener("click",function(){ ud('/'); });

document.getElementById("CE").addEventListener("click",function(){clc(); });
